...
namespace Gareon.WebService.Repositories.Context
{
    public partial class AccountServiceContext : DbContext
    {
        ...
        {
            modelBuilder.Entity<UniqueKill>(entity =>
            {
                entity.HasKey(x => x.Id);

                entity.ToTable("srZor_uniques");

                entity.Property(x => x.CharName)
                    .HasMaxLength(20);
                
                entity.Property(x => x.MobName)
                    .HasMaxLength(50);

                entity.Property(x => x.TimeString)
                    .HasColumnName("time")
                    .HasMaxLength(100);
            });
